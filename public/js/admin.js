...
const SETTINGS_FIELDS = [
  ...
  { key: 'maxDiscount', label: 'Desconto maximo (%)', type: 'number' },
  { key: 'minPrice', label: 'Preco minimo (R$)', type: 'number' },
  { key: 'maxPrice', label: 'Preco maximo (R$)', type: 'number' },
  { key: 'minRating', label: 'Avaliacao minima (0 a 5)', type: 'number' },
  { key: 'minSales', label: 'Vendas minimas', type: 'number' },
  ...
  { key: 'preferredKeywords', label: 'Palavras-chave preferidas (virgula)', type: 'text' },
  { key: 'preferredStores', label: 'Lojas preferidas (virgula)', type: 'text' },
  ...
  { key: 'officialStoresOnly', label: 'Priorizar lojas oficiais', type: 'boolean' },
